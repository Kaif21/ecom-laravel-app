        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('subcategory.create') }}" class="slide-item">Add Sub Category</a></li>
                        <li><a href="{{ route('subcategory.index') }}" class="slide-item">Manage Sub Category</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                        enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M43.394 0H4.606A4.611 4.611 0 0 0 0 4.607v38.787A4.609 4.609 0 0 0 4.606 48h38.788A4.609 4.609 0 0 0 48 43.394V4.607A4.611 4.611 0 0 0 43.394 0zM16.485 1.455h5.333v6.174a6.576 6.576 0 0 0-2.646 2.721 6.592 6.592 0 0 0-2.687-2.744zM19.9 18.423v-5.09a5.091 5.091 0 1 1 5.091 5.09zm10.181 6.547a5.091 5.091 0 0 1-10.182 0v-5.092h5.091a5.1 5.1 0 0 1 5.091 5.092zm-16.728-6.547a5.091 5.091 0 1 1 5.091-5.09v5.09zm5.091 1.456v5.092a5.091 5.091 0 1 1-5.091-5.092zM1.455 4.607a3.155 3.155 0 0 1 3.151-3.152H15.03v5.561a6.518 6.518 0 0 0-7.99 8.015H1.455V4.607zm0 11.877h6.182a6.6 6.6 0 0 0 2.732 2.668 6.591 6.591 0 0 0-2.732 2.666H1.455zm13.576 30.063H4.607A3.155 3.155 0 0 1 1.456 43.4V23.274h5.585a6.518 6.518 0 0 0 6.313 8.242 6.4 6.4 0 0 0 1.677-.229v15.26zm6.787 0h-5.333V30.7a6.588 6.588 0 0 0 2.687-2.742 6.606 6.606 0 0 0 2.646 2.721zm24.727-3.153a3.155 3.155 0 0 1-3.151 3.152H23.273V31.278a6.52 6.52 0 0 0 8.032-8.006h15.241v20.122zm0-21.576H30.707a6.588 6.588 0 0 0-2.731-2.666 6.587 6.587 0 0 0 2.731-2.668h15.838zm0-6.787H31.3a6.524 6.524 0 0 0-8.032-8.006v-5.57h20.125a3.155 3.155 0 0 1 3.151 3.152v10.424z" fill="#1a171b"/></svg>
                        <br>
                ...
                <li class="slide">
                    ...
                    {{-- <ul class="slide-menu">
                        <li><a href="maps.html" class="slide-item">Manage Order</a></li>
                    </ul> --}}
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
