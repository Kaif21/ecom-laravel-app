                                        ...
                                        <div class="single-form form-default">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 form-input form">
                                                    <textarea type="text" placeholder="Full address" name="address"></textarea>
                                                </div>
                                                <br>
                                                <div class="col-md-12 form-input form">
                                                    <label for=""><input type="radio" checked placeholder="" name="payment_method" value="COD">Cash on Delivery</label>
                                                    <label for=""><input type="radio" placeholder="" name="payment_method" value="Online">Online payment</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="checkout-sidebar">
                    <div class="checkout-sidebar-price-table">
                        ...
                        <div class="sub-total-price">
                            ...
                            <div class="total-price shipping">
                                <p class="value">Tax:</p>
                                <p class="price">{{$tax = $sum*.15 }}</p>
                            </div>
                        </div>
                        <div class="total-payable">
                            <div class="payable-price">
                                <p class="value">Total amount:</p>
                                <p class="price">{{$sum+$tax+$shipping}}</p>
                            </div>
                        </div>
